# a counter which will track the frequencey of all the elements
# each frequewncy will have a different stack(list) in a defaultdict with list
# a counter with max frequency
class FreqStack:
