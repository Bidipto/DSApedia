#kinda the problem where you feel good after solving it
#lot of cases to think about all at the same time
#the gfg version requires to return a string whereas leetcode is inplace
